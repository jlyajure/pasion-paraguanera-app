            ...
            try {
                ...
                if (catalogoPublico) {
                    ...
                    const imagenHTMLCliente = prod.foto 
                        ...
                        : `<div style="width: 100%; height: auto; aspect-ratio: 4 / 3; background-color: #333; border-radius: 6px; display: flex; justify-content: center; align-items: center; font-size: 40px; margin-bottom: 10px;">📦</div>`;
