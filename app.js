            ...
            try {
                ...
                if (catalogoPublico) {
                    ...
                    const imagenHTMLCliente = prod.foto 
                        ? `<img src="${prod.foto}" alt="${nombre}" style="width: 100%; height: auto; aspect-ratio: 16 / 9; object-fit: cover; border-radius: 6px 6px 0 0;">`
                        : `<div style="width: 100%; height: auto; aspect-ratio: 16 / 9; background-color: #333; border-radius: 6px 6px 0 0; display: flex; justify-content: center; align-items: center; font-size: 40px;">📦</div>`;
                    ...
                    divCliente.innerHTML = `
                        ...
                        <button class="btn-whatsapp btn-agregar-carrito" data-id="${prod.id}" style="margin-top: auto; display: flex; justify-content: center; align-items: center; font-size: 14px; padding: 10px;">
