            ...
            try {
                ...
                if (catalogoPublico) {
                    ...
                    const imagenHTMLCliente = prod.foto 
                        ...
                        : `<div style="width: 100%; aspect-ratio: 4/3; background-color: #333; border-radius: 6px 6px 0 0; display: flex; justify-content: center; align-items: center; font-size: 40px;">📦</div>`;
