    ...
    onSnapshot(collection(db, "productos"), (snapshot) => {
        ...
        productosActuales.forEach((prod) => {
            try {
                ...
                /* INYECCIÓN DE ALTURA ESTRICTA A LA FOTO DE ADMIN */
                const imagenHTMLAdmin = prod.foto 
                    ? `<img src="${prod.foto}" class="foto-producto-lista" alt="${nombre}">`
                    : `<div class="foto-producto-lista" style="background-color: #333; display: flex; justify-content: center; align-items: center; font-size: 24px; height: 110px;">📦</div>`;
                ...
                if (catalogoPublico) {
                    ...
                    /* INYECCIÓN DE ALTURA ESTRICTA A LA FOTO PÚBLICA */
