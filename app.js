            ...
            try {
                ...
                if (catalogoPublico) {
                    ...
                    const imagenHTMLCliente = prod.foto 
                        // MODIFICACIÓN CLAVE: Inyectamos el height de 110px directamente al HTML que genera JS
                        ? `<img src="${prod.foto}" alt="${nombre}" style="width: 100%; height: 110px; object-fit: cover; border-radius: 6px 6px 0 0;">`
                        : `<div style="width: 100%; height: 110px; background-color: #333; border-radius: 6px 6px 0 0; display: flex; justify-content: center; align-items: center; font-size: 40px;">📦</div>`;
                    ...
                    divCliente.innerHTML = `
                        <div style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
                            ...
                            <div style="padding: 10px; border-top: 1px solid #333; text-align: center;">
                                ...
                                <button class="btn-whatsapp btn-agregar-carrito" data-id="${prod.id}" style="width: 100%; background-color: #25D366; color: white; border: none; padding: 10px; border-radius: 5px; font-weight: bold; font-size: 1em; cursor: pointer; display: flex; justify-content: center; align-items: center;">
